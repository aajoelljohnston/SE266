...
switch($action) {
    ...
    case 'empty_cart':
        ...
        break;
    case 'end_session':
        // Clear the session data from the memory
        $_SESSION = array();
        ...
        $name = session_name();                // Get the session cookie name
        $expire = strtotime('-1 year');        // Create expiration date has to be in the past
